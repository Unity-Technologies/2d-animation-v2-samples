...
This Branch(2019.2/Samples) repository contains samples for 2D Animation v2 features to be used with Unity 2019.2
...
## Getting Started
1. Download and install the latest Unity 2019.2, here: https://unity3d.com/get-unity/download
...
## Compatibility
The maximum supported version for Animation v1 is 2018.2. For future experimentation with this feature we highly recommend moving to 2019.2 to use Animation v2.
